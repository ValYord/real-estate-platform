...
export default function GoogleButton({ next, disabled }: GoogleButtonProps) {
  ...
  return (
    <button
      ...
      className="border border-gray-300 h-11 rounded-lg w-full flex items-center justify-center gap-2 text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
    >
      {loading ? (
